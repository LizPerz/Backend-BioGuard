...
public class EventoMetabolico
{
    ...
    [BsonElement("es_escalamiento_emergencia")]
    public bool EsEscalamientoEmergencia { get; set; } = false;

    [BsonElement("contactos_notificados")]
    public List<string> ContactosNotificados { get; set; } = new();

    [BsonElement("variables_irme")]
    public Dictionary<string, double> VariablesIrmE { get; set; } = new();
}
