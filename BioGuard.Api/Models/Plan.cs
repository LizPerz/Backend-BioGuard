...
public class Plan
{
    ...
    [BsonElement("guardian_nocturno_disponible")]
    public bool GuardianNocturnoDisponible { get; set; } = false;

    [BsonElement("exportacion_reportes_disponible")]
    public bool ExportacionReportesDisponible { get; set; } = false;
