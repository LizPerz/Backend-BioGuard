...
public class CuidadorServiceTests
{
    ...
    public async Task CrearAsync_DatosValidos_RetornaCuidadorYCodigo()
    {
        ...
        var (success, cuidador, codigo, error) = await _service.CrearAsync(
    ...
    public async Task EliminarAsync_CuidadorExiste_RetornaTrue()
    {
        ...
        var mockTokens = new Mock<IMongoCollection<RefreshToken>>();
        mockTokens.Setup(t => t.UpdateManyAsync(
        ...
        _mockDb.Setup(db => db.RefreshTokens).Returns(mockTokens.Object);
