...
public class MLIntegrationTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    private const string DuenoUserId = "user123";
    ...
    private void SetupOwnership()
    {
        _mockDb.Setup(db => db.FindFirstOrDefaultAsync(
            ...
            .ReturnsAsync(new Paciente { Id = PacienteId, UsuarioWebId = DuenoUserId });
    }

    private void SetupAiConsoleAccess()
    {
        ...
        _mockDb.Setup(db => db.FindFirstOrDefaultAsync(
            ...
            .ReturnsAsync(new UsuarioWeb { Id = DuenoUserId, PlanId = "plan1" });
        ...
        _mockDb.Setup(db => db.FindFirstOrDefaultAsync(
            ...
            .ReturnsAsync(new Plan { Id = "plan1", AiConsole = true });
    }
